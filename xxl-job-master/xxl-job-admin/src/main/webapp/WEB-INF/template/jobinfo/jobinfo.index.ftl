			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					...
					<div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">报警手机<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="phone" placeholder="请输入手机号" maxlength="50" ></div>
...
public class DemoGlueJobHandler extends IJobHandler {
	...
	public ReturnT<String> execute(String... params) throws Exception {
		...
		//String json = HttpProxy.get("http://127.0.0.1:8080/xxl-job-admin");
      	//XxlJobLogger.log("返回值"+json);
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					...
					<div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">报警手机<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="phone" placeholder="请输入手机号码" maxlength="50" ></div>
